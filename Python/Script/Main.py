#!/usr/bin/python
#coding:utf-8
# from Class import StockCal
from Class import Stock
from Class import CalculateStocks
from Class import CalculationInfo
...
# StockCode = ["300052","300033"]
# StockName = ["中青宝","同花顺"]

def main():
    calculator = CalculateStocks.CalculateStock(StockCode, StockName)
